...
import { updateClientAPI, getClientById } from '../../APIServices/mastersAPI/clientsAPI';
    ...
    return (
        <div className='w-full h-full p-9 bg-gray-300 rounded-xl'>
            <div className='flex justify-between bg-white rounded-2xl p-4 mb-4'>
                ...
                <Link to="/admin-dashboard/clientlist" className="hover:bg-red-400">
                    <div>Client List</div>
                </Link>
            </div>
            <form className='mt-6 h-full max-w-fit' onSubmit={formik.handleSubmit}>
                <div className='space-y-6'>
                    <div className='grid grid-cols-2 gap-6'>
                        {[
                            { id: 'name', label: 'Client Name', type: 'text', placeholder: 'Client Name' },
                            { id: 'contact', label: 'Contact', type: 'text', placeholder: 'Client Contact' },
                            ...
                            { id: 'email', label: 'Email', type: 'email', placeholder: 'Client Email' },
                            { id: 'occupation', label: 'Occupation', type: 'text', placeholder: 'Occupation' },
                            { id: 'designation', label: 'Designation', type: 'text', placeholder: 'Designation' },
                            { id: 'organization', label: 'Organization', type: 'text', placeholder: 'Organization' },
                            { id: 'source', label: 'Source', type: 'text', placeholder: 'Source' }
