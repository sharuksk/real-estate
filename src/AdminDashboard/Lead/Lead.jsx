...
export const Lead = () => {
  ...
  // Fetch agents
  const { data: response = {}, isLoading: agentsLoading, error: agentsError } = useQuery({
    queryKey: ['agents'],
  ...
  const agents = response.agents && Array.isArray(response.agents) ? response.agents : [];
  ...
  return (
    <div className='w-full h-full p-9 bg-gray-300 rounded-xl'>
      <div className='flex justify-between bg-white rounded-2xl p-4 mb-2'>
        ...
        <Link to="/admin-dashboard/leadlist" className="bg-green-400 h-full px-6 rounded-lg hover:bg-red-400">
          <div>Lead List</div>
        </Link>
      </div>
      ...
      <form className='mt-6 h-full max-w-sm' onSubmit={formik.handleSubmit}>
        <div className='space-y-6'>
          <div className='flex items-center gap-6'>
            <label htmlFor='leadName' className='font-medium text-gray-700 w-32'>Lead Name</label>
            <input
              id='leadName'
              type='text'
          ...
          {formik.touched.leadName && formik.errors.leadName && (
            <div className="text-red-500 text-sm ml-32">{formik.errors.leadName}</div>
          )}
  
          <div className='flex items-center gap-6'>
            <label htmlFor='contact' className='font-medium text-gray-700 w-32'>Contact</label>
            <input
              id='contact'
              type='text'
          ...
          {formik.touched.contact && formik.errors.contact && (
            <div className="text-red-500 text-sm ml-32">{formik.errors.contact}</div>
          )}
  
          <div className='flex items-center gap-6'>
            <label htmlFor='location' className='font-medium text-gray-700 w-32'>Location</label>
            <input
              id='location'
              type='text'
          ...
          {formik.touched.location && formik.errors.location && (
            <div className="text-red-500 text-sm ml-32">{formik.errors.location}</div>
          )}
  
          <div className='flex items-center gap-6'>
            <label htmlFor='email' className='font-medium text-gray-700 w-32'>Email</label>
            <input
              id='email'
              type='email'
          ...
          {formik.touched.email && formik.errors.email && (
            <div className="text-red-500 text-sm ml-32">{formik.errors.email}</div>
          )}
  
          <div className='flex items-center gap-6'>
            <label htmlFor='propertyType' className='font-medium text-gray-700 w-32'>Property Type</label>
            <select
              id='propertyType'
          ...
          {formik.touched.propertyType && formik.errors.propertyType && (
            <div className="text-red-500 text-sm ml-32">{formik.errors.propertyType}</div>
          )}
  
          <div className='flex items-center gap-6'>
            <label htmlFor='source' className='font-medium text-gray-700 w-32'>Source</label>
            <select
              id='source'
          ...
          {formik.touched.source && formik.errors.source && (
            <div className="text-red-500 text-sm ml-32">{formik.errors.source}</div>
          )}
  
          <div className='flex items-center gap-6'>
            <label htmlFor='agentName' className='font-medium text-gray-700 w-32'>Agent Name</label>
            <select
              id='agentName'
          ...
          {formik.touched.agentName && formik.errors.agentName && (
            <div className="text-red-500 text-sm ml-32">{formik.errors.agentName}</div>
          )}
