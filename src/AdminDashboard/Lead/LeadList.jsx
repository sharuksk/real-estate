      ...
      <div className='container px-4 mx-auto'>
        <div className='flex flex-col space-y-4'>
          <div className='flex flex-col sm:flex-row sm:justify-between items-center pb-4 border-b bg-white rounded-lg'>
            ...
            <button className="bg-[#58ac3b] p-2 rounded-full mt-2  mr-4 sm:mt-0">Add Lead</button>
          </Link>
          ...
          <div className='bg-white border-b rounded-2xl overflow-x-auto'>
              ...
              <tbody>
                {leads.length ? (
                  leads.map((lead, index) => (
                    <tr
                      key={lead._id}
                      className={`rounded-2xl ${index % 2 === 0 ? 'bg-gray-200' : 'bg-gray-100'} mb-4`}
                    >
            ...
            <div className='flex gap-4 justify-center mt-5'>
              ...
              <button
                onClick={() => setPage((old) => (page < totalPages ? old + 1 : old))}
