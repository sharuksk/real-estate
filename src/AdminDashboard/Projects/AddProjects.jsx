      ...
      <div className="flex flex-col gap-4 w-full">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6 md:gap-8">
          <div className="flex flex-col md:flex-row w-full gap-4 md:gap-14 items-start md:items-center">
            <label className="font-semibold text-base md:text-lg">Project Name</label>
            <input
              type="text"
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex flex-col md:flex-row w-full gap-4 md:gap-9 items-start md:items-center">
              <label className="font-semibold text-base md:text-lg">Project Location</label>
              <input
                type="text"
                className="flex w-full md:w-1/2 rounded-3xl p-2 focus:outline-none"
            ...
            <div className="flex flex-col md:flex-row w-full gap-4 md:gap-9 items-start md:items-center">
              <label className="font-semibold text-base md:text-lg">Project Area</label>
              <input
                type="text"
                className="flex w-full md:w-1/2 rounded-3xl p-2 focus:outline-none"
          ...
          <div className="flex flex-col md:flex-row w-full gap-4 md:gap-8">
            <label className="font-semibold text-base md:text-lg">Project Description</label>
            <textarea
          ...
          <div className="flex flex-col md:flex-row w-full gap-4 md:gap-28">
            <label className="font-semibold text-base md:text-lg mt-2">Images</label>
