...
import { deletePropertyTypeAPI, getPropertyTypeAPI } from '../../APIServices/mastersAPI/propertyTypeAPI';
                                ...
                                <tbody>
                                    {listpropertyType.length ? (
                                      listpropertyType.map((propertytype) => (
                                        ...
                                        <tr>
                                            <td colSpan="3" className="text-center py-4">No amenities found</td>
                                        </tr>
                                    )}
                                </tbody>
                            </table>
